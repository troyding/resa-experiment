 ...
 */
public class testAggOutlierDetection {
    ...
    public static void main(String[] args) throws Exception {
        ...
        IRichBolt projectionBolt = new testProjection(new ArrayList<>(randVectors));
        ...
        IRichBolt detectorBolt = new testDetector(objectCount, minNeighborCount, maxNeighborDistance);
        ...
        IRichBolt updaterBolt = new testUpdater(randVectors.size());
