 ...
 * capabilities.
 */
public class TomExpServiceWCTopology3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("splitBP", new SplitSentence(ConfigUtil.getDouble(conf, "a3-splitBP.mu", 1.0)),
                ConfigUtil.getInt(conf, "a3-splitBP.parallelism", 1)).shuffleGrouping("spout", "Bolt-P");

        builder.setBolt("splitBPnot", new SplitSentence(ConfigUtil.getDouble(conf, "a3-splitBPnot.mu", 1.0)),
        ...
        builder.setBolt("counter", new WordCounter(ConfigUtil.getDouble(conf, "a3-counter.mu", 1.0)),
