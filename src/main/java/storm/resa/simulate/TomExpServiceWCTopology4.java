 ...
 * capabilities.
 */
public class TomExpServiceWCTopology4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("split", new SplitSentence(ConfigUtil.getDouble(conf, "a4-split.mu", 1.0)),
        ...
        builder.setBolt("counter", new WordCounterT2(ConfigUtil.getDouble(conf, "a4-counter.mu", 1.0), ConfigUtil.getDouble(conf, "a4-loopback.prob", 0.0)),
